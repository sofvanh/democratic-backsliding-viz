...
df = df[['country_name', 'country_text_id', 'year', 'v2x_polyarchy',
...
geojson_countries = {feature['properties']['NAME']
...
print("Countries in dataset not found in GeoJSON after renaming:",
...
print("Countries in GeoJSON not found in dataset after renaming:",
...
geojson_iso_to_country = {feature['properties']['ADM0_A3']
...
for series in result:
    ...
    if iso_code not in geojson_iso_to_country:
        iso_mismatches.append(
            (iso_code, country_name, "ISO code not found in GeoJSON"))
    elif geojson_iso_to_country[iso_code] != country_name:
        iso_mismatches.append((iso_code, country_name, f"Mismatch: GeoJSON country is {
                              geojson_iso_to_country[iso_code]}"))
